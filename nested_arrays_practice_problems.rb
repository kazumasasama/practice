...
# i = 0
# j = 0
# while i <  letters_1.length
#   j = 0
#   while j < letters_2.length
#     combined_letters << letters_1[i] + letters_2[j]
#     j += 1
#   end
#   i += 1
# end
...
while i < letters.length
  ...
  while j < letters.length
    if letters[i] != letters[j]
      combined_letters << letters[i] + letters[j]
    end
    j += 1
  end
  i += 1
